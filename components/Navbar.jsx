    ...
    return (<>
      <header className="sticky top-0 z-30 h-20 border-b backdrop-blur-xl bg-[#FAF8F5]/90 dark:bg-[#141010]/90 border-[#E2DBD0] dark:border-[#3B3030] px-4 lg:px-8 flex items-center justify-between transition-colors">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={toggleTheme} className="p-2.5 rounded-2xl text-[#181414] dark:text-[#FAF8F5] bg-[#FFFFFF] dark:bg-[#201A1A] hover:bg-[#810100]/10 border border-[#E2DBD0] dark:border-[#3B3030] shadow-sm transition-all duration-200 active:scale-95" aria-label="Toggle Theme">
          ...
          <button onClick={onOpenAddModal} className="flex items-center gap-2 px-4 py-2.5 rounded-2xl text-xs font-extrabold bg-gradient-to-r from-[#810100] to-[#630000] hover:from-[#630000] hover:to-[#810100] text-white shadow-md cherry-glow transition-all duration-200 active:scale-95">
      ...
      <CommandPaletteModal isOpen={isCommandOpen} onClose={() => setIsCommandOpen(false)} onOpenAddModal={onOpenAddModal}/>
    </>);
}
