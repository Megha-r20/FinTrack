...
export default function DashboardLayout({ children }) {
    ...
    return (<div className="min-h-screen bg-[#FAF8F5] dark:bg-[#141010] text-[#181414] dark:text-[#FAF8F5] flex">
      ...
      {sidebarOpen && (<div onClick={() => setSidebarOpen(false)} className="fixed inset-0 z-30 bg-black/60 backdrop-blur-sm lg:hidden"/>)}

      {/* Main Content Workspace */}
      <div className="flex-1 lg:pl-64 flex flex-col min-w-0">
        <Navbar onToggleSidebar={() => setSidebarOpen(!sidebarOpen)} onOpenAddModal={() => setIsAddModalOpen(true)}/>
