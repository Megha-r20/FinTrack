...
export default function BudgetsPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2.5 rounded-xl text-xs font-bold bg-[#FAF8F5] dark:bg-[#201A1A] text-[#141010] dark:text-[#FAF8F5] border border-[#E2DBD0] dark:border-[#3B3030] hover:bg-[#E2DBD0]/40 transition-colors shadow-sm"
          >
      ...
      <StudentPacingCard
        summary={summary}
        onApplyPreset={handleApplyHostelPreset}
      ...
      {/* Budgets Grid */}
      {loading ? (
        <div className="p-12 text-center text-xs font-medium text-[#594D4D] animate-pulse">
          Loading budget allocations...
        </div>
      ) : budgetsList.length === 0 ? (
        <div className="p-12 text-center bg-[#FFFFFF] dark:bg-[#201A1A] border border-[#E2DBD0] dark:border-[#3B3030] rounded-3xl space-y-4">
          ...
          <button
            onClick={handleApplyHostelPreset}
            disabled={applyingPreset}
            className="px-5 py-2.5 rounded-xl text-xs font-black bg-gradient-to-r from-[#810100] to-[#630000] text-white shadow-md cherry-glow inline-flex items-center gap-2"
          >
