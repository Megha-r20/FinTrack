    ...
    return (<div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {goals.map((goal) => {
            ...
            return (<div key={goal.id} className={`p-6 rounded-3xl bg-[#FFFFFF] dark:bg-[#201A1A] border transition-all shadow-sm flex flex-col justify-between space-y-4 ${isDone
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  {isDone ? (<span className="flex items-center gap-1 text-[10px] font-extrabold px-2.5 py-0.5 rounded-full bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 border border-emerald-500/30">
                      <CheckCircle2 className="w-3 h-3"/> Completed
                    </span>) : (<span className="flex items-center gap-1 text-[10px] font-bold text-[#594D4D]">
              ...
              <div className="space-y-1.5">
                ...
                <div className="w-full bg-[#E2DBD0] dark:bg-[#3B3030] h-3 rounded-full overflow-hidden">
                  <div className={`h-full rounded-full transition-all duration-500 ${isDone ? "bg-emerald-500" : "bg-[#810100]"}`} style={{ width: `${goal.percentageCompleted}%` }}/>
                </div>
              </div>
